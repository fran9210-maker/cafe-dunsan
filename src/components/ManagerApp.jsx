...
// 없으면 updatedAt, createdAt, date+time 순서로 안전하게 정렬합니다.
    ...
    const htmlContent = `
      <html>
        ...
        <body>
          ...
          ${!isReceipt ? `<div class="order-num">주문번호: ${String(order.id || '').slice(-4).toUpperCase()}</div>` : ''}
  ...
  return (
    ...
    >
      ...
      <div>
              ...
              {orders.length === 0 ? (
                ...
                orders.map((order) => (
                  <div
                    ...
                    style={{
                      display: 'grid',
                      gridTemplateColumns: '1.3fr 1.2fr 1fr 1fr',
                      gap: '10px',
                      padding: '10px 0',
                      borderBottom: `1px solid ${colors.border}`,
                      alignItems: 'center',
        ...
        {activeTab === 'stats' && (
          <Statistics orders={orders} menus={menus} />
        )}
